...
function updateUser(id) {
  let [name, username, email, street, suite, city, zipcode, phone, website, companyName, catchPhrase, bs] = event.target.querySelectorAll('input') ;

  document.getElementById(`${id}`).querySelector('.name').innerText = name.value;
  document.getElementById(`${id}`).querySelector('.userName').innerText = username.value;
  document.getElementById(`${id}`).querySelector('.email').innerText = email.value;
  document.getElementById(`${id}`).querySelector('.street').innerText = street.value;
  document.getElementById(`${id}`).querySelector('.suite').innerText = suite.value;
  document.getElementById(`${id}`).querySelector('.city').innerText = city.value;
  document.getElementById(`${id}`).querySelector('.zipcode').innerText = zipcode.value;
  document.getElementById(`${id}`).querySelector('.phone').innerText = phone.value;
  document.getElementById(`${id}`).querySelector('.website').innerText = website.value;
  document.getElementById(`${id}`).querySelector('.companyName').innerText = companyName.value;
  document.getElementById(`${id}`).querySelector('.catchPhrase').innerText = catchPhrase.value;
...
// })
// .then(res => res.json())
// .then(data => console.log(data)) // or res.json()
